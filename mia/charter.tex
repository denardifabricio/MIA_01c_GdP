...
% El título de la memoria, se usa en la carátula y se puede usar em cualquier lugar del documento con el comando \ttitle
\titulo{Desarrollo de un asistente de cocina a partir de modelos grandes de lenguaje} 

% Nombre del posgrado, se usa en la carátula y se puede usar en cualquier lugar del documento con el comando \degreename
